...
import sys
sys.path.append("/home/bing4090/sapien_env/act/detr")
...
from sapien_env.teleop.replay_episode import save_videos
...
def main(args):
    ...
    # get task parameters
    is_sim = True
    dataset_dir = '/home/bing4090/sapien_env/data/scripted/scripted_random005'
    num_episodes = 2
    episode_len = 1000
    camera_names = ["left_view", "bird_view"]
...
def eval_bc(config, ckpt_name, save_episode=True):
    ...
    for rollout_id in range(num_rollouts):
        ...
        cams = gui.cams
        for cam in cams:
            image_list[f'/observations/images/{cam.name}'] = []
        qpos_list = []
        target_qpos_list = []
        rewards = []

        # gui.viewer.paused = True
        with torch.inference_mode():
            for t in range(max_timesteps):
                ...
                qpos_numpy = np.array(env.robot.get_qpos()[:-1])
                ...
                for cam in gui.cams:
                    ...
                    curr_image = rearrange(rgb, 'h w c -> c h w')
                    curr_images.append(curr_image)
                    image_list[f'/observations/images/{cam.name}'].append(rgb)
...
## train
# python3 act/imitate_episodes.py --task_name relocate --ckpt_dir /home/bing4090/sapien_env/data/checkpoint --policy_class ACT --kl_weight 10 --chunk_size 100 --hidden_dim 512 --batch_size 8 --dim_feedforward 3200 --num_epochs 2  --lr 1e-5 --seed 0
