...
class SapienEnvWrapper:
    ...
    def reset(self):
        ...
        if True:
            ...
            prompt_info["prompt"] = "There are a green green battery and a purple battery outside the crate, put them into slots which in line with corresponding color batteries." + "\n"
