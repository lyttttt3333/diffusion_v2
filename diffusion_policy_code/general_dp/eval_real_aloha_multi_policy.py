...
def main(input_dirs, output, match_dataset, match_episode,
    vis_camera_idx, vis_d3fields, robot_sides,
    steps_per_inference, max_duration,
    frequency, command_latency, n_action_steps):
    # load match_dataset
    match_camera_idx = 0
                ...
                try:
                    ...
                    while True:
                        ...
                        if key_stroke == ord('s'):
                            ...
                            if policy_idx + 1 >= len(ckpt_paths):
                                print("No more policy to load!")
                                continue
                            del policy
                            env.reset()
                            policy_idx += 1
